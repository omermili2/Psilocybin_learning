  ...
  */
  class SurveyTemplatePlugin {
    ...
    trial(display_element, trial) {
      ...
      html += '<div class="survey-template-container" dir="rtl">';
      ...
      for (var i = 0; i < trial.items.length; i++) {
        ...
        html += `<div class='survey-template-prompt' style="text-align:right; direction:rtl;">${trial.items[item_order[i]]}</div>`;
