...
var jsPsychPreAlienPractice = (function (jspsych) {
  'use strict';

  const info = {

    name: "pre-alien-practice",
    description: '',
    parameters: {
      aliens: {
  ...
  class PreAlienPracticePlugin {
    ...
    var after_second_response = function(info) {
      ...
      // Present feedback.
      state_2_feedback(response.state_2_key)
    ...
    var state_2_feedback = function(side) {
  ...
  PreAlienPracticePlugin.info = info;

  return PreAlienPracticePlugin;
